...
### Authoritative Benchmark Receipts (Host Hardware, 2026-08-20, Two Independent Runs)
- **Routing Throughput**: 2.3–2.8 Million routing decisions/second single core (Run A: 2.75 M @ 363.40 ns/decision, Run B: 2.32 M @ 430.75 ns/decision).
- **Conjugate Grid Sign Inversion (400×400 L2)**: 37.06–39.63 Giga-trits/second (Run A: 39.63 Gtrits/s @ 4.04 µs/pass, Run B: 37.06 Gtrits/s @ 4.32 µs/pass, AVX2 scalar).
- **Double-Buffer Host Staging Throughput**: 59.37–60.09 GB/s (Run A: 59.37 GB/s @ 17.32 ns/swap, Run B: 60.09 GB/s @ 17.11 ns/swap; 57.75–58.45 M swaps/s).
- **Sovereign Airgap Leakage**: 0.00% leakage; 100% vector defense under Red/Green validation (verified across 5 sentinel gates).
