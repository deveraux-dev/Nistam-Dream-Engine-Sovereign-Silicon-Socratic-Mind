...
consumer GPU, governed in the cloud by Google Cloud Vertex AI gemini-3.7-flash (enforcing
...
(ASP+FST+GBNF), and Google Vertex AI Gemini 3.7 Flash Governor.*
...
Vertex AI gemini-3.7-flash context cache at temperature 0.0 with a strict $0.0004/call ceiling.
...
spending a token, requests a schema-locked audit from gemini-3.7-flash on Google Cloud
...
- **Demo video:** [https://youtu.be/ttMofC_9-G0](https://youtu.be/ttMofC_9-G0) (≤4:00, English subtitles.)
