...
CANONICAL_DECK_3MIN = VideoDeck(
    ...
    scenes=[
        ...
        VideoScene(
            ...
            narrative_vo_center="Accountability is self-attestation, not surveillance. No ending is silent.",
            audio_phase_driver="udle_vibematrix.shaderbind (Ch0: rms, Ch1: beat_phase controls Video B opacity over A)",
            on_screen_visual_prompt="Hero closing title lock: Surface Ledger & Forge-Envelope, Zenodo DOI badge (10.5281/zenodo.22176968), Google Gemini Competition badge, and GitHub / Crates.io links. Tagline: 'No ending is silent. Every erasure is witnessed.'",
            live_terminal_command=None
        )
    ]
)
